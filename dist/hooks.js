...
export const useEmailVerificationForm = () => {
    ...
    const submit = (actionCodeSettings) => __awaiter(void 0, void 0, void 0, function* () {
        setInProgress(true);
        setIsComplete(false);
        setError(undefined);
        try {
            yield sendEmailVerification(actionCodeSettings);
            setIsComplete(true);
        }
        catch (e) {
...
export const useChangePasswordForm = () => {
    ...
    const [inProgress, setInProgress] = useState(false);
    const [error, setError] = useState();
    const submit = ({ currentPassword, newPassword, newPasswordConfirm, }) => __awaiter(void 0, void 0, void 0, function* () {
