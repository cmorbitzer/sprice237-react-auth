...
export const isFirebaseError = (error) => error.name === 'FirebaseError';
export const isInFirebaseErrorMessages = (code) => code in FirebaseErrorMessages;
export const getFirebaseErrorMessage = (e) => {
    if (!isFirebaseError(e) || !isInFirebaseErrorMessages(e.code)) {
        throw e;
    }
